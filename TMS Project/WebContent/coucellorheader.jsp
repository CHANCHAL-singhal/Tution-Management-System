 ...
 <div class="navbar1">
  ...
  <div class="dropdown1">
    ...
    <div class="dropdown-content">
      ...
      <a href="updatestock1.jsp">Edit Stock Detail</a>
      <a href="showallstock.jsp">Show All stock</a>
    </div>
  </div>
  
  <!-- <div class="dropdown1">
    <button class="dropbtn">Payment<span class="caret"></span>
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="fees.jsp">Add Payment Details</a>
       <a href="updatefees.jsp">Edit Details</a>
    </div>
  </div> -->
