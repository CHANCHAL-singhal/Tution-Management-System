	...
	<%
		...
		if (!str.equalsIgnoreCase("")) {
			...
			try {
				...
				String sql="select * from exam_attendance where exa_id = ? and present = ? ";
				PreparedStatement stmt=conn.prepareStatement(sql);
				stmt.setInt(1, eid);
				stmt.setString(2, "absent");
				...
				{
					out.println("<tr class='a'><td colspan='2'>No Students Found for This Exam OR All Are Present</td></tr>");
				}
