...
<br/>
<br/>
<h1><b><font color="white">Add Students Attendance</font></b></h1>
<br/>

<div class="w3l-main">
	<div class="w3l-from">
								<form action="Stu_attController" method="post" id="stuatt">
								<input type="hidden" name="bid" >
									...
									<div class="w3l-user">
										...
										<input type="date" name="date" id="date" style="width : 250px" >
										</div>
										<center>
										<div class="btn">
										<input type="button"  name="btnnext" value="Next" onclick="showStudents();" id="btnnext"/>
